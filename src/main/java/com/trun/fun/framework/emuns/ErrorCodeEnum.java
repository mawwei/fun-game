package com.trun.fun.framework.emuns;
...
public enum ErrorCodeEnum {
    ...
    BAD_REQUEST_NULL(HttpServletResponse.SC_BAD_REQUEST, true, "查询结果为NULL"),
    BAD_DMDGROUP_NULL(HttpServletResponse.SC_BAD_REQUEST, true, "需求分组信息为NULL"),
    BAD_DMDGROUPID_NULL(HttpServletResponse.SC_BAD_REQUEST, true, "需求项分组ID为NULL"),
